@forelse ($duplikats as $log)
   <tr>
    ...
    <td>{{ $log->pengaduans->first()->users->name }} <a href="#myModal" id="openBtn" data-toggle="modal" data-target="{{ '#' . $log->id . 'modal' }}"><span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span></a>
