{!! Form::open(['url' => route('perusahaan.destroy', $log->id), 'method' => 'delete',  'class'=>'delete form-inline']) !!}
    <a class="btn btn-primary btn-xs" href="{{ route('perusahaan.edit', $log->id) }}"><span class="glyphicon glyphicon-edit" aria-hidden="true" data-toggle="tooltip" title="Edit"></span></a>
